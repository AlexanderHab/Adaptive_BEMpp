...
class GridView(object):
    ...
    def refine(self):
        ...
        domain_indices = []
        new_reference_edges = []
        ftos = (-1)*np.ones((number_of_elements, 4),dtype='int') #alexx
        new_element_count =0 
	    ...
	    # check if refenrence edge (hence element) is refined # alexx	
            if refinement_list[i, ref_index] != -1:
                ...
                if refinement_list[i, (ref_index + 1) % 3] != -1:
                    ...
                    ftos[i,0] = new_element_count			#alexx
                    ...
                    domain_indices.append(element.domain)
                    ftos[i,1] = new_element_count			#alexx
                    new_element_count = new_element_count +1
                    ...
                    if refinement_list[i, (ref_index + 2) % 3] == -1:
                        ...
                        domain_indices.append(element.domain)
                        ftos[i,2] = new_element_count			#alexx
                        new_element_count = new_element_count +1
                        continue
                ...
                if refinement_list[i, (ref_index + 2) % 3] != -1:
                    ...
                    new_reference_edges.append(2)
                    domain_indices.append(element.domain)
                    ftos[i,3] = new_element_count			#alexx
                    new_element_count = new_element_count +1
